     ...
     <div className="fixed top-0 left-0 bottom-0 right-0 z-50 bg-neutral-800 bg-opacity-70 p-4 flex justify-center items-center"> 
      <div className="bg-white w-full max-w-md p-4 rounded">
        <div className="flex justify-between items-center gap-3">
          <h1 className="font-semibold">Permanent Deletion</h1>
        ...
        <div className="w-fit ml-auto flex items-center gap-3">
          <button onClick={confirm} className="px-4 py-1 border rounded border-red-500 text-red-500 hover:bg-red-500 hover:text-white">Confirm</button>
