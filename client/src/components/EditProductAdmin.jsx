...
const EditProductAdmin = ({ close,data:propsData }) => {
     ...
     return (
          <section className="fixed top-0 left-0 w-full h-full bg-black z-50 bg-opacity-70 p-4">
               <div className="bg-white w-full max-w-2xl mx-auto rounded p-4 overflow-y-auto h-full max-h-[95vh]">
                    <section>
                         <div className="p-2 bg-white shadow-md flex items-center justify-between">
                              <h2 className="font-semibold">Upload Product</h2>
                              <button onClick={close} className="hover:bg-red-100 p-2 rounded">
                                   <IoClose size={25} />
                              </button>
                         </div>
                              ...
                              <form className="grid gap-4" onSubmit={handleSubmit}>
                                        ...
                                        <div>
                                             ...
                                             <div className="flex flex-wrap gap-4">
                                                  {data.image.map((img, index) => (
                                                       <div key={img + index} className="w-20 mt-1 h-20 min-w-20 bg-blue-50 border relative group">
                                                            <img
                                                                 src={img}
                                                                 alt={img}
                                   ...
                                   <div className="grid gap-1">
                                        ...
                                        <div>
                                             ...
                                             >
                                                  <option value={""} className="text-neutral-500">Select Sub Category</option>
                                   ...
                                   <div 
                                        ...
                                        className="hover:bg-primary-200 bg-white py-1 px-3 w-32 text-center font-semibold border border-primary-200 hover:text-neutral-900 rounded cursor-pointer"
                                   >
                                        Add Fields
                                   </div>
