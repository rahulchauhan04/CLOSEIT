    ...
    <section className="w-full container mx-auto px-2">
      <div className="bg-white my-4 w-full max-w-lg mx-auto rounded p-7">
        ...
        <form className="grid gap-4 mt-6" onSubmit={handleSubmit}>
          ...
          <button disabled={!valideValue} className={`${ valideValue ? "bg-green-800" : "bg-gray-500" } hover:bg-green-700 text-white py-2 rounded font-semibold my-3 tracking-wide`}>Register</button>
