...
const SubCategoryPage = () => {
      ...
      cell: ({ row }) => {
        return (
          <div className="flex justify-center items-center gap-3">
            <button className="p-2 bg-green-100 rounded-full hover:text-green-600" onClick={
              () => {
                setOpenEdit(true);
                setEditData(row.original);
              }
            }><HiPencil size={20} /> </button>
            <button className="p-2 bg-red-100 rounded-full text-red-500 hover:text-red-600" onClick={
              () => {
  ...
  return (
    <section>
          ...
          {/* table here to display the subcategory data from the database  */}
          ...
          {
            openEdit &&
            <EditSubCategory data={editData} close={() => setOpenEdit(false)} fetchhData={fetchSubCategory}/>
          }
